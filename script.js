...
function submitQuiz() {
    ...
    var answers = {
        q1: getSelectedValue(form, 'q1'),
        q2: getSelectedValue(form, 'q2'),
        q3: getSelectedValue(form, 'q3')
    };
    ...
    // Calculate the score (you can customize this based on your quiz)
...
function calculateScore(answers) {
    // You can customize the scoring logic based on correct answers
    var score = 0;
